...
/**
 * DataTable — animated table with header row and zebra-striped data rows.
 * `highlightRows` is an array of 0-based indices to emphasize.
 *
 * Keep `rows.length` and `headers.length` constant per section.
 */
